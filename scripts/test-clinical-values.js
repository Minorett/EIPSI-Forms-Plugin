...
const {
	calculateLabelLeftPercent,
} = require( '../src/blocks/vas-slider/calculateLabelSpacing.js' );
...
const testCases = [
	{
		...
		alignment: 100,
		expected: [ 5, 50, 87 ],
		description: '3 labels, alignment 100',
	},
	{
		labels: 3,
		alignment: 50,
		expected: [ 20, 50, 70 ],
		description: '3 labels, alignment 50',
	},
	{
		labels: 4,
		alignment: 100,
		expected: [ 5, 30, 70, 88 ],
		description: '4 labels, alignment 100',
	},
	{
		labels: 4,
		alignment: 50,
		expected: [ 15, 35, 65, 80 ],
		description: '4 labels, alignment 50',
	},
	{
		labels: 5,
		alignment: 100,
		expected: [ 5, 25, 50, 75, 90 ],
		description: '5 labels, alignment 100',
	},
	{
		labels: 5,
		alignment: 50,
		expected: [ 15, 28, 50, 70, 80 ],
		description: '5 labels, alignment 50',
	},
];
...
testCases.forEach( ( testCase ) => {
	...
	const passed =
		JSON.stringify( calculated ) === JSON.stringify( testCase.expected );
