...
<head>
    ...
    <title>Recordatorio importante - {{survey_name}}</title>
    <style>
        ...
        .highlight-box { background-color: #fff8e1; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 0 4px 4px 0; }
        ...
        .button { display: inline-block; background-color: #ff9800; color: #ffffff !important; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: 500; margin-top: 10px; text-align: center; font-size: 16px; width: 100%; box-sizing: border-box; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="urgent-text">Hace algunos días que tu evaluación está disponible y aún no la hemos recibido.</p>
            
            <div class="highlight-box">
                <p style="margin: 0;"><strong>Evaluación pendiente: {{wave_index}}</strong></p>
                <p style="margin: 5px 0 0; font-size: 14px;">Tiempo estimado: <strong>{{estimated_time}} minutos</strong></p>
            </div>
            
            {{due_date_html}}
            
            <p>Sin tu participación, no podemos completar el estudio. Si tienes algún problema para acceder, por favor contáctanos.</p>
