...
<head>
    ...
    <title>Recordatorio amable - {{survey_name}}</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Recordatorio amable</h1>
        </div>
        <div class="content">
            <p>Hola <strong>{{first_name}}</strong>,</p>
            <p>Esperamos que estés teniendo un buen día. Te escribimos para recordarte amablemente que tienes una evaluación pendiente.</p>
            ...
            <p>Sabemos que tu tiempo es valioso, pero tu participación nos ayuda muchísimo en la investigación.</p>
