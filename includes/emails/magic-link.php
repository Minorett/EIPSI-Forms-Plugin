...
<head>
    ...
    <title>Acceso rápido: {{survey_name}}</title>
    <style>
        ...
        .header .badge { display: inline-block; background: #3B6CAA; color: #fff; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; text-transform: uppercase; margin-bottom: 10px; }
        ...
        .custom-message-box { background-color: #fef5e7; border: 1px dashed #e67e22; padding: 15px; margin: 20px 0; border-radius: 4px; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="highlight-box">
                <p style="margin: 0;"><strong>Este es tu acceso directo al estudio.</strong></p>
                <p style="margin: 5px 0 0;">Hacé clic para entrar sin contraseña.</p>
            </div>
            ...
            <p style="text-align: center; margin: 30px 0;">
                <a href="{{magic_link}}" class="button">Entrar al estudio</a>
            </p>

            <p class="meta-info">Este enlace es único y expira en 48 horas.</p>
        </div>
        <div class="footer">
