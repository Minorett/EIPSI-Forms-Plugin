...
function testPreset( preset ) {
	...
	tests.push(
		testContrast(
			'Input Border Focus vs Background',
			config.colors.inputBorderFocus,
			config.colors.background,
			3.0
		)
	);
...
function validatePresets() {
	...
	console.log(
		'║   WCAG 2.1 Level AA Contrast Validation for EIPSI Forms   ║'
	);
	console.log(
		'╚════════════════════════════════════════════════════════════╝\n'
	);
	...
	STYLE_PRESETS.forEach( ( preset ) => {
		...
		console.log(
			`│  ${ preset.description || 'Default theme configuration' }\n│`
		);
