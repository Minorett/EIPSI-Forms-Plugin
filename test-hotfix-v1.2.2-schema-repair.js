...
test( 'Documentation includes all 3 layers', () => {
	const docFile = path.join(
		__dirname,
		'HOTFIX_v1.2.2_AUTO_DB_SCHEMA_REPAIR.md'
	);

	assertFileContains(
		docFile,
		'LAYER 1',
		'Documentation must describe Layer 1'
	);
	assertFileContains(
		docFile,
		'LAYER 2',
		'Documentation must describe Layer 2'
	);
	assertFileContains(
		docFile,
		'LAYER 3',
		'Documentation must describe Layer 3'
	);
} );
...
if ( failCount === 0 ) {
	console.log(
		'🎉 All tests passed! Schema repair implementation is complete.\n'
	);
