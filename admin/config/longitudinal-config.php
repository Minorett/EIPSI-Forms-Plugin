 ...
 */
if (!defined('EIPSI_MAGIC_LINK_EXPIRY_HOURS')) {
 ...
 */
if (!defined('EIPSI_MAGIC_LINK_MAX_USES')) {
 ...
 */
if (!defined('EIPSI_MAGIC_LINK_TOKEN_LENGTH')) {
 ...
 */
if (!defined('EIPSI_WAVE_INDEX_MIN')) {
 ...
 */
if (!defined('EIPSI_WAVE_DEFAULT_STATUS')) {
 ...
 */
if (!defined('EIPSI_CRON_EMAIL_RATE_LIMIT')) {
 ...
 */
if (!defined('EIPSI_WAVE_REMINDER_INTERVAL_HOURS')) {
 ...
 */
if (!defined('EIPSI_WAVE_MAX_REMINDERS')) {
 ...
 */
if (!defined('EIPSI_ANONYMOUS_EMAIL_PREFIX')) {
 ...
 */
if (!defined('EIPSI_ANONYMOUS_EMAIL_DOMAIN')) {
 ...
 */
if (!defined('EIPSI_AUDIT_REQUIRED_ACTIONS')) {
 ...
 */
if (!defined('EIPSI_LOGIN_MAX_ATTEMPTS')) {
 ...
 * Default: 15 minutos
 */
if (!defined('EIPSI_LOGIN_LOCKOUT_TIME_MINUTES')) {
 ...
 */
if (!defined('EIPSI_SESSION_INACTIVITY_TIMEOUT_HOURS')) {
 ...
 */
if (!defined('EIPSI_LONGITUDINAL_DEBUG')) {
 ...
 */
if (!defined('EIPSI_PERFORMANCE_LOGGING')) {
 ...
 */
if (!defined('EIPSI_LONGITUDINAL_MIN_VERSION')) {
 ...
 */
if (!defined('EIPSI_AUTO_MIGRATE_ENABLED')) {
 ...
 */
if (!defined('EIPSI_ANONYMIZED_DATA_RETENTION_DAYS')) {
 ...
 */
if (!defined('EIPSI_ALLOW_DELETE_ANONYMIZED_DATA')) {
